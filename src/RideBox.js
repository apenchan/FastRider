...
//       }} className="ride-description row" type="button" id={this.props.id} value={this.props.id} onClick={this.props.getRideId}>
//         <div className="ride-zone col-sm">{this.props.zone.name}</div><div className="ride-name" value={this.props.id} onClick={this.props.getRideId} id={this.props.id}> {this.props.name} </div><div className="remaining-tickets">{this.props.remaining_tickets}</div></button>
//     )
//   }
// }
...
class RideBox extends React.Component {
  ...
  render() {
    ...
    <button style={{
        ...
        <div className="ride-time">{this.props.getDate(this.props.return_time)}</div>
        <div className="remaining-tickets">{this.props.remaining_tickets}</div>
    </button>
    )
  }
}
